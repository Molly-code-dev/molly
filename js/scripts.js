...
function displayBooks(booksdata) {
    ...
    for (let i = 0; i < booksArray.length; i++) {
        ...
        const cardElement = `
        <div class="media mb-5 p-5 bg-white text-dark">
          ...
          <div class="media-body">
            ...
            <p class="card-text">${booksArray[i].volumeInfo.description}<br><br><span><a class = "card-link " href="${booksArray[i].volumeInfo.previewLink}">More Details</a></span></p>
          </div>
        </div>
    `;
